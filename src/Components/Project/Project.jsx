...
import jobapp from '../../assets/job-app.jpg'
        ...
        <div className='project'>
            ...
            <div className='projects'>
                <div className='projectsBar'>
                    <img className='proImg' src={jobapp} alt='' />
                    <div className='proText'>
                        <h2>Job Application</h2>
                        <p>Technologies: Next.js, PostgreSQL, TailwindCss, Prisma, etc</p>
                    </div>
                ...
                <div className='projectsBar'>
                    ...
                    <div className='probuttom'>
                        ...
                        <button className='buttonsare' onClick={() => handleHotelBookingSite("https://hotel-booking-client1221.onrender.com")}>Live Site</button>
                    </div>
                </div>
                <div className='projectsBar'>
                    ...
                    <div className='probuttom'>
                        ...
                        <button className='buttonsare' onClick={() => handleDiarySite("https://e-commerce-client123.onrender.com")}>Live Site</button>
                    </div>
                </div>
                <div className='projectsBar'>
                    ...
                    <div className='probuttom'>
                        ...
                        <button className='buttonsare' onClick={() => handleSocialMediaSite("https://social-media-client-92jx.vercel.app")}>Live Site</button>
                    </div>
                </div>
